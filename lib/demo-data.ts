...
export const salesPeriods = [
  { label: "Mar 15 - Apr 14", key: "2026-03" },
...
export const demoSalesAsms = [
  {
    ...
    disciplineScore: 5,
    reportingScore: 5,
    managerNote: "Sales target owner profile. KPI actuals will populate after ERP data is available for NV0001."
  },
  {
    id: "NV0494",
    name: "Ma Van Nam",
    region: "Phu Tho - Thai Nguyen - Vinh Phuc",
    manager: "Võ Minh Chánh",
    periodKey: "2026-05",
    revenueTarget: 500,
    revenueActual: 510,
    newCustomersTarget: 10,
