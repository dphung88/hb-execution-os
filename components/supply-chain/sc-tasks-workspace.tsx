...
import { createScTaskAction, updateScTaskAction } from "@/app/(app)/supply-chain/tasks/actions";
...
export function ScTasksWorkspace({ tasks, source, searchParams, periods = [], selectedPeriod = "" }: Props) {
  ...
  const boardRows = SC_OWNERS.map((owner) => {
          ...
          <div className="min-w-[860px]">
            ...
            <div className="divide-y divide-slate-100">
              {boardRows.map(({ owner, task }) => {
                ...
                return (
                  <form key={task.id} action={updateScTaskAction}
