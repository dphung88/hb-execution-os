    ...
    <div className="space-y-6">
      <section className="rounded-[2rem] border border-white/70 bg-slate-950 px-6 py-8 text-white shadow-panel">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="mt-1 text-2xl font-semibold tracking-tight sm:text-4xl">{demoMeetingInsight.title}</h1>
          </div>
        </div>
      </section>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.05fr,0.95fr]">
        <div className="rounded-3xl border border-white/70 bg-white/85 p-6 shadow-panel">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-brand-700">Transcript summary</p>
        ...
        <div className="rounded-3xl border border-white/70 bg-white/85 p-6 shadow-panel">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-brand-700">Action extraction</p>
