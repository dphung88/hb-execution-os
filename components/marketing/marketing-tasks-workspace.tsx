            ...
            <div className="divide-y divide-slate-100">
              {filteredTasks.map((task) => (
                <form
                  ...
                  className="grid grid-cols-[minmax(260px,1.35fr)_minmax(140px,0.7fr)_120px_120px_minmax(220px,0.95fr)_110px] items-center gap-4 px-5 py-3"
                >
                  ...
                  <div>
                    <input
                      ...
                      className="h-10 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-900 outline-none transition focus:border-brand-400"
                    />
                    {task.fileLink ? <p className="mt-1 text-xs text-slate-500">File link attached</p> : null}
                  </div>
